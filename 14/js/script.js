...
/* harmony import */ var _utils_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/scene-2d.js */ "./source/js/utils/scene-2d.js");
/* harmony import */ var _utils_easings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/easings.js */ "./source/js/utils/easings.js");
...
class CrocodileScene extends _utils_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
  ...
  initAnimations() {
    this.animations.push(new _utils_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: () => {
        this.drawScene();
      },
      duration: `infinite`,
  ...
  initKeyAnimations() {
    this.animations.push(new _utils_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 300,
      easing: _utils_easings_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInCubic
    }));
  }
  ...
  initDropAnimations() {
    ...
    this.dropAnimations.push(new _utils_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: (progress) => {
  ...
  initFlamingoAnimations() {
    this.animations.push(new _utils_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 1000,
      delay: 200,
      easing: _utils_easings_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutCubic,
      callback: () => {
        const animation = new _utils_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
          func: (progress) => {
...
/***/ "./source/js/canvas-scenes/win-scene.js":
/*!**********************************************!*\
  !*** ./source/js/canvas-scenes/win-scene.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WinScene; });
/* harmony import */ var _utils_animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/animation */ "./source/js/utils/animation.js");
/* harmony import */ var _utils_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/scene-2d.js */ "./source/js/utils/scene-2d.js");
/* harmony import */ var _utils_easings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/easings.js */ "./source/js/utils/easings.js");
...
class WinScene extends _utils_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    const canvas = document.getElementById(`win-scene-canvas`);
  ...
  initPlaneAnimations() {
    this.animations.push(new _utils_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 500,
      delay: 1200,
      easing: _utils_easings_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInQuad
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _utils_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 2000,
      delay: 1000,
      easing: _utils_easings_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutElastic
    }));
...
/* harmony import */ var _utils_numbers_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/numbers-animation */ "./source/js/utils/numbers-animation.js");
...
class FullPageScroll {
  ...
  changePageDisplay() {
    if (this.activeScreen === this.PRIZES_SCREEN_INDEX) {
      ...
      setTimeout(() => {
        new _utils_numbers_animation__WEBPACK_IMPORTED_MODULE_1__["default"](`.prizes__desc b`, 0, 0, 1, 3).startTimer();
      }, 1200);

      setTimeout(() => {
        new _utils_numbers_animation__WEBPACK_IMPORTED_MODULE_1__["default"](`.prizes__desc b`, 1, 0, 1, 7).startTimer();
      }, 4500);

      setTimeout(() => {
        new _utils_numbers_animation__WEBPACK_IMPORTED_MODULE_1__["default"](`.prizes__desc b`, 2, 11, 80, 900).startTimer();
      }, 7500);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _canvas_scenes_win_scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../canvas-scenes/win-scene */ "./source/js/canvas-scenes/win-scene.js");
/* harmony import */ var _canvas_scenes_lose_scene__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../canvas-scenes/lose-scene */ "./source/js/canvas-scenes/lose-scene.js");
      ...
      result.addEventListener(`click`, () => {
        ...
        switch (targetId) {
          case `result`:
            ...
            new _canvas_scenes_win_scene__WEBPACK_IMPORTED_MODULE_0__["default"]();
            break;

          case `result3`:
            // eslint-disable-next-line no-new
            new _canvas_scenes_lose_scene__WEBPACK_IMPORTED_MODULE_1__["default"]();
            break;
...
/* harmony import */ var _utils_animate_letters__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils/animate-letters */ "./source/js/utils/animate-letters.js");
/* harmony import */ var _utils_reload_svg_animation__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils/reload-svg-animation */ "./source/js/utils/reload-svg-animation.js");
// modules
...
document.body.addEventListener(`screenChanged`, (evt) => {
  ...
  if (screenName === `prizes`) {
    Object(_utils_reload_svg_animation__WEBPACK_IMPORTED_MODULE_11__["default"])(`.prizes__item img`);
  }
...
animationNodes.forEach((node) => Object(_utils_animate_letters__WEBPACK_IMPORTED_MODULE_10__["default"])(node, 0.5));
Object(_utils_animate_letters__WEBPACK_IMPORTED_MODULE_10__["default"])(introDateNode, 1.5);
 ...
 */
/* harmony default export */ __webpack_exports__["default"] = ((node, delay = 0, interval = 0.05) => {
...
/* harmony import */ var _easings_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./easings.js */ "./source/js/utils/easings.js");
...
/***/ "./source/js/utils/easings.js":
/*!************************************!*\
  !*** ./source/js/utils/easings.js ***!
  \************************************/
/*! exports provided: easeLinear, easeInCubic, easeOutCubic, easeInExpo, easeOutExpo, easeInElastic, easeOutElastic, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./source/js/utils/numbers-animation.js":
/*!**********************************************!*\
  !*** ./source/js/utils/numbers-animation.js ***!
  \**********************************************/
/*! exports provided: default */

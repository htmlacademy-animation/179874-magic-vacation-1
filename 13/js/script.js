  ...
  if (results.length) {
    showResultEls.forEach((result) => {
      result.addEventListener(`click`, () => {
        ...
        const initScene = new _canvas_scenes_win_scene__WEBPACK_IMPORTED_MODULE_0__["default"]();
      });
    });
